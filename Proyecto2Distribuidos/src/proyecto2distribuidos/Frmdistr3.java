...
import proyecto2distribuidos.distribuidor2.Distribuidor2;
...
import proyecto2distribuidos.distribuidor3.Distribuidor3;
 ...
 * @author ignacio
 */
public class Frmdistr3 extends javax.swing.JFrame implements Observer{

    /**
     * Creates new form Frm2
     */
    public Frmdistr3() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        this.getRootPane().setDefaultButton(this.btnEnviar);
        //conexion a la BD
        ConexionBDdistribuidor3 cdb3 = Singleton_conexion3.getInstancia().getConexiondb();
        Distribuidor3 c = new Distribuidor3(8000,cdb3);
        c.addObserver(this);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DISTRIBUIDOR 3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frmdistr3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmdistr3().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Frmdistr3.class.getName()).log(Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    Logger.getLogger(Frmdistr3.class.getName()).log(Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    Logger.getLogger(Frmdistr3.class.getName()).log(Level.SEVERE, null, ex);
