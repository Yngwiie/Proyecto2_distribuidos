 ...
 * @author Javier
 */
public class Conexion_Postgres2 extends ConexionBDdistribuidor2 {
     ...
     * por el lenguaje SQL.
     */
    public Conexion_Postgres2(String database, String username, String password) throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
     ...
     * por el lenguaje SQL.
     */
    public Conexion_Postgres2() throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException{
        this("distribuidor2", "postgres", "mas");
    }
