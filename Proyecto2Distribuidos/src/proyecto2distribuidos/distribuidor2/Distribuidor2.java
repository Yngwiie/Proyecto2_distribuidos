 ...
 * @author ignacio
 */
public class Distribuidor2 extends Observable implements Runnable {

    
    private int puerto;
    private ConexionBDdistribuidor2 cbd;
    
    public Distribuidor2(int puerto,ConexionBDdistribuidor2 cbd){
        this.puerto = puerto;
        this.cbd = cbd;
    }
    ...
    public void run() {
        ...
        try {            
            ...
            Logger.getLogger(Distribuidor2.class.getName()).log(Level.SEVERE, null, ex);
