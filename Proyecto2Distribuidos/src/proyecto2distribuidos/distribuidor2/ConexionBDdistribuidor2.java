 ...
 * @author Javier
 */
public class ConexionBDdistribuidor2 {
     ...
     * por el lenguaje SQL.
     */
    public ConexionBDdistribuidor2(String jdbc, String driver, String host, String database,String username,String password) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        this.jdbc = jdbc;
        this.driver = driver;
        this.host = host;
