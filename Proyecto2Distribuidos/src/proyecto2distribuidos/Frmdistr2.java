 ...
 * @author ignacio
 */
public class Frmdistr2 extends javax.swing.JFrame implements Observer{

    /**
     * Creates new form Frm2
     */
    public Frmdistr2() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        this.getRootPane().setDefaultButton(this.btnEnviar);
        //conexion a la BD
        ConexionBDdistribuidor2 cdb2 = Singleton_conexion2.getInstancia().getConexiondb();
        Distribuidor2 c = new Distribuidor2(7000,cdb2);
        c.addObserver(this);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DISTRIBUIDOR 2");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frmdistr2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmdistr2().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Frmdistr2.class.getName()).log(Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    Logger.getLogger(Frmdistr2.class.getName()).log(Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    Logger.getLogger(Frmdistr2.class.getName()).log(Level.SEVERE, null, ex);
